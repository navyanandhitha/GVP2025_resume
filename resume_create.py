...
if submitted:
    ...
    # Save PDF and prepare for download
    with tempfile.NamedTemporaryFile(delete=False, suffix=".pdf") as tmp:
        pdf.output(tmp.name)

    # Read binary and pass to download_button
    with open(tmp.name, "rb") as f:
        pdf_bytes = f.read()

    st.success("✅ Resume generated successfully!")
    st.download_button("📥 Download Resume PDF", data=pdf_bytes, file_name="My_Resume.pdf", mime="application/pdf")
